...
import com.deeznut.spring_boot_library.requestmodels.AdminQuestionRequest;
import com.deeznut.spring_boot_library.service.MessagesService;
...
public class MessagesController {
    ...
    public void putMessage(@RequestHeader(value = "Authorzation") String token,
